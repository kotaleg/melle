...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_shop__ = __webpack_require__(57);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    modules: {
        shop: __WEBPACK_IMPORTED_MODULE_2__modules_shop__["a" /* default */]
    },
    strict: debug
}));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isUndefined__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    getInlineState: function getInlineState(cb, errorCb) {
        if (!__WEBPACK_IMPORTED_MODULE_0_lodash_isUndefined___default()(window['__' + __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$codename + '__'])) {
            cb(window['__' + __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$codename + '__']);
        } else {
            errorCb();
        }
    },
    postSettingData: function postSettingData(data, cb, errorCb) {
        __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$http.post(data.url, data).then(function (response) {
            cb(response);
        }).catch(function (error) {
            errorCb(error.responce);
        });
    },
    operateAllRequest: function operateAllRequest(data, cb, errorCb) {
        __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$http.post(data.url, data).then(function (response) {
            cb(response);
        }).catch(function (error) {
            errorCb(error.responce);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_js_toggle_button__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_App_vue__ = __webpack_require__(58);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$codename = 'super_offers';

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_notification___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vue_js_toggle_button___default.a);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    }).$mount('#' + __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$codename);
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_shop__ = __webpack_require__(18);
...
var state = {
    ...
    getToggleStates: function getToggleStates(state) {
        return {
    ...
    initData: function initData(_ref) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__api_shop__["a" /* default */].getInlineState(function (data) {
            commit('setData', data);
        });
    }
};
...
var mutations = {
    ...
    updateSetting: function updateSetting(state, _ref2) {
    ...
    setLoadingProgress: function setLoadingProgress(state, progress_data) {
        state.loading_progress = progress_data.progress;
        state.loading_message = progress_data.message;
    },
    clearLoadingProgress: function clearLoadingProgress(state) {
...
Component.options.__file = "admin/view/javascript/super_offers_admin/src/components/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6e85d13e", Component.options)
  } else {
    hotAPI.reload("data-v-6e85d13e", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(62)("b87eeb08", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6e85d13e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6e85d13e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_extend__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__partial_PageHeader_vue__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__partial_PageHeader_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__partial_PageHeader_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__partial_Breadcrumbs_vue__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__partial_Breadcrumbs_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__partial_Breadcrumbs_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__partial_Panel_vue__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__partial_Panel_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__partial_Panel_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__api_shop__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__partial_notify__ = __webpack_require__(108);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        'page-header': __WEBPACK_IMPORTED_MODULE_2__partial_PageHeader_vue___default.a,
        'breadcrumbs': __WEBPACK_IMPORTED_MODULE_3__partial_Breadcrumbs_vue___default.a,
        'panel-default': __WEBPACK_IMPORTED_MODULE_4__partial_Panel_vue___default.a
    },
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["d" /* mapState */])('shop', ['breadcrumbs', 'version', 'heading_title', 'button_save_and_stay', 'button_save', 'button_cancel', 'text_edit', 'text_status', 'text_close', 'text_cancel', 'text_warning', 'cancel', 'save', 'setting', 'somethingLoading']), Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapGetters */])('shop', ['getToggleStates', 'getSettingValue']), {
        status: {
            get: function get() {
                return this.getSettingValue('status');
            },
            set: function set(value) {
                this.updateSetting({ index: 'status', value: value });
            }
        }
    }),
    created: function created() {
    ...
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["c" /* mapMutations */])('shop', ['updateSetting', 'setLoadingStatus', 'setLoadingProgress', 'clearLoadingProgress']), {
        saveAndStay: function saveAndStay() {
            var _this = this;

            this.setLoadingStatus(true);
            var data = __WEBPACK_IMPORTED_MODULE_0_lodash_extend___default()({}, this.setting, { url: this.save });
            __WEBPACK_IMPORTED_MODULE_5__api_shop__["a" /* default */].postSettingData(data, function (res) {
                _this.setLoadingStatus(false);
                __WEBPACK_IMPORTED_MODULE_6__partial_notify__["a" /* default */].messageHandler(res.data);
            });
        },
        saveAndGo: function saveAndGo() {
            ...
            var data = __WEBPACK_IMPORTED_MODULE_0_lodash_extend___default()({}, this.setting, { url: this.save });
            __WEBPACK_IMPORTED_MODULE_5__api_shop__["a" /* default */].postSettingData(data, function (res) {
                _this2.setLoadingStatus(false);
                __WEBPACK_IMPORTED_MODULE_6__partial_notify__["a" /* default */].messageHandler(res.data);

                setTimeout(function () {
                    window.location.href = _this2.cancel;
                }, 1500);
            });
        }
    })
...
Component.options.__file = "admin/view/javascript/super_offers_admin/src/components/partial/PageHeader.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-97afe68c", Component.options)
  } else {
    hotAPI.reload("data-v-97afe68c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("div", { staticClass: "page-header" }, [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("h1", [_vm._v(_vm._s(_vm.title) + " " + _vm._s(_vm.version))]),
        _vm._v(" "),
        _vm._t("default")
      ],
      2
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-97afe68c", module.exports)
  }
}
...
Component.options.__file = "admin/view/javascript/super_offers_admin/src/components/partial/Breadcrumbs.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cd711bfc", Component.options)
  } else {
    hotAPI.reload("data-v-cd711bfc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.crumbs, function(breadcrumb, k) {
      return _c("li", { key: k }, [
        _c("a", {
          attrs: { href: breadcrumb.href },
          domProps: { textContent: _vm._s(breadcrumb.text) }
        })
      ])
    }),
    0
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cd711bfc", module.exports)
  }
}
...
Component.options.__file = "admin/view/javascript/super_offers_admin/src/components/partial/Panel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-196c6cb6", Component.options)
  } else {
    hotAPI.reload("data-v-196c6cb6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "panel panel-default" }, [
    _c(
      "div",
      { staticClass: "panel-heading", staticStyle: { clear: "both" } },
      [
        ...
        _vm._v(" "),
        _c("span", { staticClass: "pull-right" }, [_vm._v(_vm._s(_vm.extra))])
      ]
    ),
    _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-196c6cb6", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
    messageHandler: function messageHandler(data) {
        if (data.success && __WEBPACK_IMPORTED_MODULE_0_lodash_isArray___default()(data.success)) {
            data.success.forEach(function (element) {
                __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$notify({
                    group: __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$codename,
                    type: 'success',
                    title: __WEBPACK_IMPORTED_MODULE_2__store_index__["a" /* default */].state.shop.text_success,
                    text: element
                });
            }, this);
        } else if (data.error && __WEBPACK_IMPORTED_MODULE_0_lodash_isArray___default()(data.error)) {
            data.error.forEach(function (element) {
                __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$notify({
                    group: __WEBPACK_IMPORTED_MODULE_1_vue___default.a.prototype.$codename,
                    type: 'warn',
                    title: __WEBPACK_IMPORTED_MODULE_2__store_index__["a" /* default */].state.shop.text_warning,
                    text: element
                });
            }, this);
        }
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("notifications", {
        attrs: { group: this.$codename, position: "bottom right" }
      }),
      _vm._v(" "),
      _c(
        "page-header",
        { attrs: { title: _vm.heading_title, version: _vm.version } },
        [
          _c("template", { slot: "buttons" }, [
            _c(
              "button",
              {
                ...
                attrs: {
                  "data-toggle": "tooltip",
                  title: _vm.button_save_and_stay
                },
                on: { click: _vm.saveAndStay }
              },
            ...
            _c(
              "button",
              {
                ...
                attrs: { "data-toggle": "tooltip", title: _vm.button_save },
                on: { click: _vm.saveAndGo }
              },
              [_c("i", { staticClass: "fa fa-save" })]
            ),
            _vm._v(" "),
      ...
      _c(
        ...
        { staticClass: "container-fluid" },
        [
          _c("panel-default", { attrs: { title: _vm.text_edit } }, [
            _c("form", { staticClass: "form-horizontal" }, [
              _c("div", { staticClass: "form-group clearfix" }, [
                _c(
                  "label",
                  { staticClass: "col-sm-3 col-lg-2 control-label" },
                  [_vm._v(_vm._s(_vm.text_status))]
                ),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "col-sm-9 col-lg-5" },
                  [
                    _c("toggle-button", {
                      attrs: {
                        width: 80,
                        height: 25,
                        labels: _vm.getToggleStates
                      },
                      model: {
                        value: _vm.status,
                        callback: function($$v) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6e85d13e", module.exports)
  }
}
