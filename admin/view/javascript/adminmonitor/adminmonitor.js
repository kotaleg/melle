var adminmonitor = {
    firstClickOnStartDate: true,
    firstClickOnEndDate: true,
    init : function(init_settings) {
        var user_token = init_settings.user_token;
        ...
        var load_list = function(page, callback) {
            ...
            $.ajax({
                url: "index.php?route=" + module_path + "/list_events&user_token=" + user_token + "&page=" + page + get_filters(),
                type: "GET",
                dataType: "json",
                beforeSend: function() {
        ...
        var delete_selected = function(callback) {
            $.ajax({
                url: "index.php?route=" + module_path + "/delete_events&user_token=" + user_token,
                type: "POST",
                dataType: "json",
        ...
        $('.date').datetimepicker({
          ...
          var fieldName = e.target.querySelector('input').name;
          if (fieldName == "filter_start" && adminmonitor.firstClickOnStartDate) {
            adminmonitor.firstClickOnStartDate = false;
          } else if (fieldName == "filter_end" && adminmonitor.firstClickOnEndDate) {
            adminmonitor.firstClickOnEndDate = false;
          } else {
            load_list();
          }
        });
