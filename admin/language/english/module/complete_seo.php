...
<p>SEO titles are not automatically applied to your theme because this will be changing your design, so you have to manually insert them in your themplates.<br/><br/>Files to modify (.tpl or .twig):<br/><code style="padding:0">/catalog/view/theme/[theme]/template/common/home<br/>/catalog/view/theme/[theme]/template/product/product<br/>/catalog/view/theme/[theme]/template/product/category<br/>/catalog/view/theme/[theme]/template/product/information<br/>/catalog/view/theme/[theme]/template/product/manufacturer</code><br/><br/>Insert these codes for .tpl (please not $heading_title is automatically containing $seo_h1, so it is generally not necessary to put seo h1, just h2 and h3): <br/><code style="padding:0">&lt;h1&gt;&lt;?php echo $seo_h1; ?&gt;&lt;/h1&gt;<br/>&lt;h2&gt;&lt;?php echo $seo_h2; ?&gt;&lt;/h2&gt;<br/>&lt;h3&gt;&lt;?php echo $seo_h3; ?&gt;&lt;/h3&gt;</code><br/><br/>Or these codes for .twig  (please not {{ heading_title }} is automatically containing {{ seo_h1 }}, so it is generally not necessary to put seo h1, just h2 and h3): <br/><code style="padding:0">&lt;h1&gt;{{ seo_h1 }}&lt;/h1&gt;<br/>&lt;h2&gt;{{ seo_h2 }}&lt;/h2&gt;<br/>&lt;h3&gt;{{ seo_h3 }}&lt;/h3&gt;</code><br/></p>
...
$_['text_seo_mode_redirection']					= 'Dynamic redirection';
...
$_['text_seo_generator_product_desc']	= '<strong>Main</strong><br/><b>[name]</b> Product name<br/><b>[model]</b> Model<br/><b>[category]</b> Category name<br/><b>[parent_cat]</b> Parent category<br/><b>[cat_X]</b> Category level X (set number)<br/><b>[brand]</b> Brand name<br/><b>[desc]</b> Description extract<br/><b>[desc_sentence]</b> 1st sentence<br/><b>[price]</b> Price with tax<br/><b>[price_notax]</b> Price without tax<br/><br/><strong>Attributes and options</strong><br/><b>[attributes]</b> All attributes<br/><b>[attr_name]</b> Attribute (replace name)<br/><b>[opt_name]</b> Option (replace name)<br/><br/><strong>Product data</strong><br/><b>[upc]</b> <b>[sku]</b> <b>[ean]</b> <b>[jan]</b> <b>[isbn]</b> <b>[mpn]</b> <b>[location]</b> <b>[prod_id]</b> <b>[cat_id]</b><br/><br/><strong>Special tags</strong><br/><b>[current]</b> Current value<br/><b>[store]</b> Store name<br/><b>[lang]</b> Current language<br/><b>[lang_id]</b> Current language ID<br/><b>{aa|bb|cc}</b> Random values<br/><b>{en}..{/en}</b> Only for lang';
$_['text_seo_generator_category']			= 'Categories';
$_['text_seo_generator_category_desc']	= '<strong>Main</strong><br/><b>[name]</b> Category name<br/><b>[desc]</b> Description extract<br/><b>[desc_sentence]</b> 1st sentence<br/><b>[parent]</b> Parent category name<br/><b>[child]</b> Child category name<br/><b>[lowest_price]</b> Lowest product price<br/><b>[highest_price]</b> Highest product price<br/><br/><strong>Special tags</strong><br/><b>[current]</b> Current value<br/><b>[store]</b> Store name<br/><b>[lang]</b> Current language<br/><b>[lang_id]</b> Current language ID<br/><b>{aa|bb|cc}</b> Random values<br/><b>{en}..{/en}</b> Only for lang';
$_['text_seo_generator_information']		= 'Informations pages';
$_['text_seo_generator_information_desc']= '<strong>Main</strong><br/><b>[name]</b> Information title<br/><b>[desc]</b> Description extract<br/><b>[desc_sentence]</b> 1st sentence<br/><br/><strong>Special tags</strong><br/><b>[current]</b> Current value<br/><b>[store]</b> Store name<br/><b>[lang]</b> Current language<br/><b>[lang_id]</b> Current language ID<br/><b>{aa|bb|cc}</b> Random values<br/><b>{en}..{/en}</b> Only for lang';
$_['text_seo_generator_manufacturer']	= 'Manufacturers';
$_['text_seo_generator_manufacturer_desc']= '<strong>Main</strong><br/><b>[name]</b> Manufacturer name<br/><br/><strong>Special tags</strong><br/><b>[current]</b> Current value<br/><b>[store]</b> Store name<br/><b>[lang]</b> Current language<br/><b>[lang_id]</b> Current language ID<br/><b>{aa|bb|cc}</b> Random values<br/><b>{en}..{/en}</b> Only for lang';
...
$_['text_seo_generator_redirect_i']	= 'Save all actual urls as 301 redirect to a dynamic link, this will make for example to save "apple-iphone" to its corresponding product id, then if later you change this product url it will be automatically redirected to the new url "apple-iphone-new"';
