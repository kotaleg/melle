...
// $url = $this->getUrl();
    ...
    protected function getForm()
    {
        ...
        } elseif ((isset($this->request->get['post_id'])) && $this->model_extension_d_blog_module_post->getPostUrl($this->request->get['post_id'])) {
            $data['seo_url'] = $this->model_extension_d_blog_module_post->getPostUrl($this->request->get['post_id']);
        } else {
            $data['seo_url'] = '';
        }
