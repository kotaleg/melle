...
class ControllerExtensionDBlogModuleCategory extends Controller {
    ...
    protected function getForm() {
        ...
        } elseif ((isset($this->request->get['category_id'])) && $this->model_extension_d_blog_module_category->getPostUrl($this->request->get['category_id'])) {
            $data['seo_url'] = $this->model_extension_d_blog_module_category->getPostUrl($this->request->get['category_id']);
        } else {
            $data['seo_url'] = '';
        }
