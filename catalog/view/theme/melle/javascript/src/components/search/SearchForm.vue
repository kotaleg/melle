<template>
  <div class="search-form">
    <form
      method="get"
      class="search-form__form ng-pristine ng-valid"
    ...
    >
      <input
        ...
        class="q search-form__input ui-autocomplete-input"
        autocomplete="off"
        v-model="search"
      /><span
        role="status"
...
export default {
  ...
  computed: {
    ...
    ...mapState('catalog', ['product_total']),
    ...
    search: {
      ...
      set(v) {
        this.updateFilterValueWithDelay({ k: 'search', v })
      },
    },
  },
  methods: {
    ...mapActions('filter', ['updateFilterValueWithDelay']),
