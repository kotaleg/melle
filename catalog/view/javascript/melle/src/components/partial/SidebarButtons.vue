<template>
    <div class="panel-buttons panel-buttons--sidebar">
        ...
        <div v-if="!is_logged" class="panel-buttons__auth-links">
        ...
        <div v-if="is_logged" class="panel-buttons__auth-links">
            <div class="panel-buttons__login">
                <a class="" :href="account_link">
                    <svg viewBox="0 0 483.5 483.5" width="20" height="20">
                        <path d="M430.75,471.2v-67.8c0-83.9-55-155.2-130.7-179.8c36.4-20.5,61.1-59.5,61.1-104.2c0-65.8-53.6-119.4-119.4-119.4s-119.4,53.6-119.4,119.4c0,44.7,24.7,83.7,61.1,104.2c-75.8,24.6-130.7,95.9-130.7,179.8v67.8c0,6.8,5.5,12.3,12.3,12.3h353.6C425.25,483.4,430.75,478,430.75,471.2z M146.75,119.4c0-52.3,42.6-94.9,94.9-94.9s94.9,42.6,94.9,94.9s-42.6,94.9-94.9,94.9S146.75,171.7,146.75,119.4z M406.25,458.9H77.05v-55.6c0-90.7,73.8-164.6,164.6-164.6s164.6,73.8,164.6,164.6V458.9z"></path>
                    </svg>
                    <span>Личный кабинет</span>
                </a>
            </div>
            <span>/</span>
            <div class="panel-buttons__reg"><a :href="logout_link"><span>Выход</span></a></div>
        </div>
        ...
        <div class="panel-buttons__basket shop-cart-container">
            <a @click="enableElement('cart')" href="javascript:void(0)" class="panel-buttons__basket-link">
                ...
                <span>Корзина</span><i v-if="hasProducts" class="itemCartCount">{{ cartCount }}</i>
            </a>
        </div>
