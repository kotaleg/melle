  ...
  <div class="panel-buttons panel-buttons--sidebar">
    ...
    <div class="panel-buttons__mail">
      <a
        ...
        class="panel-buttons__mail-link"
      >
    ...
    <div v-if="!is_logged" class="panel-buttons__auth-links">
      <div class="panel-buttons__login">
        <a
          ...
          href="javascript:void(0)"
          class="panel-buttons__login-link"
        >
      ...
      <span>/</span>
      <div @click="enableElement('register')" class="panel-buttons__reg">
        <a href="javascript:void(0)" class="panel-buttons__reg-link"
    ...
    <div class="panel-buttons__basket shop-cart-container">
      <a
        ...
        href="javascript:void(0)"
        class="panel-buttons__basket-link"
      >
