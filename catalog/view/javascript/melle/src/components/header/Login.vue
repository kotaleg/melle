    ...
    <section class="auth">
        <div class="panel-buttons panel-buttons--sidebar">
            ...
            <div class="panel-buttons__mail">
                <a @click="enableElement('mail_us')" href="javascript:void(0)" class="panel-buttons__mail-link">
            ...
            <div class="panel-buttons__auth-links">
                <div class="panel-buttons__login">
                    <a @click="enableElement('login')" href="javascript:void(0)" class="panel-buttons__login-link">
                ...
                <span>/</span>
                <div class="panel-buttons__reg"><a @click="enableElement('register')" href="javascript:void(0)" class="panel-buttons__reg-link"><span>Регистрация</span></a></div>
            </div>
            <div class="panel-buttons__basket shop-cart-container" data-ng-controller="ShopCartWidget">
                <a @click="enableElement('cart')" href="javascript:void(0)" class="panel-buttons__basket-link">
                    ...
                    <span>Корзина</span><i data-ng-show="cartCount > 0" data-ng-init="cartCount = '0'" data-ng-bind-html="cartCount" class="itemCartCount"></i>
                </a>
            </div>
        </div>
        ...
        <div id="authForm">
            <div class="auth__form form-vertical" id="yw1" method="post" v-on:submit.prevent="login()">
                ...
                <div class="auth__form-group">
                    <a @click="enableElement('forgot')" href="javascript:void(0)" class="auth__form-link auth__form-link--pas">забыли пароль?</a>
                    <input @click="login()" type="submit" value="Войти" class="auth__form-send">
