    ...
    <div id="cart-controller">
      <ul v-if="hasProducts" class="basket-modal__list">
        <li v-for="(p, i) in products" class="basket-modal__item">
          <div class="basket-modal__item-left">
            <a :href="p.href"
              ><img :src="p.thumb" class="basket-modal__prod-img"
            /></a>
          </div>
          <div class="basket-modal__item-center">
            <div class="basket-modal__prod-info">
              <div class="basket-modal__prod-title">
                <a :href="p.href">{{ p.name }}</a>
              </div>
              <div
                v-if="p.option"
                v-for="o in p.option"
                class="basket-modal__prod-article"
              >
            ...
            <div class="basket-modal__prod-count">
              ...
              <input
                type="text"
                :value="p.quantity"
                class="item_col keyPressedNum boldCount"
                readonly
              />
              <button
                class="item_plus"
              ...
              <span
                v-show="p.quantity >= p.max_quantity"
                class="catalog__item-count_label"
          ...
          <div class="basket-modal__item-right">
            ...
            <div class="basket-modal__price">
              <span class="basket-modal__price-default"
      ...
      <div class="basket-modal__footer">
        <div
          ...
          class="basket-modal__full-price"
        >
      ...
      <div
        v-if="!hasProducts"
        class="basket-modal__buttons basket-modal__buttons--empty"
      >
