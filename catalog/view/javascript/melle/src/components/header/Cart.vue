        ...
        <div class="panel-buttons">
            ...
            <div class="panel-buttons__basket shop-cart-container">
                <a href="#" class="panel-buttons__basket-link">
                    <svg viewBox="0 0 1489.733 1698.268" width="19" height="19">
                    ...
                    <span>Корзина</span><i v-if="hasProducts" class="itemCartCount">{{ count }}</i>
                </a>
            </div>
        </div>
        ...
        <div id="cart-controller">
            <ul class="basket-modal__list">
                <li v-for="(p, i) in products"
                    class="basket-modal__item" data-ng-repeat="product in cart.products">
                    <div class="basket-modal__item-left"><a :href="product.href"><img :src="product.thumb" class="basket-modal__prod-img"></a></div>
                    <div class="basket-modal__item-center">
                        ...
                        <div class="basket-modal__prod-count"><button class="item_minus" role="button" data-ng-click="cart.minusCount(product)"><span>-</span></button><input type="text" :value="product.quantity" data-ng-model="product.itemCount" data-ng-change="cart.changeCount(product)" class="item_col keyPressedNum boldCount"><button class="item_plus" role="button" data-ng-click="cart.plusCount(product)"><span>+</span></button><span class="catalog__item-count_label ng-hide" data-ng-show="product.showLimit">доступно:
                            <span data-ng-bind="product.maxCount"></span></span>
                        </div>
                    </div>
                    <div class="basket-modal__item-right">
                        <div class="basket-modal__del">
                            <button data-ng-click="cart.removeProduct(product.id)">
                        ...
                        <div class="basket-modal__price"><span class="basket-modal__price-default">{{ product.price }} <span class="ruble-sign">Р</span></span></div>
                    </div>
                </li>
            </ul>
            ...
            <div data-ng-show="cart.products" class="basket-modal__buttons">
                ...
                <a v-if="hasProducts" href="" data-ng-click="cart.clearCart()">
                    очистить корзину
            ...
            <div i-if="!hasProducts" class="basket-modal__buttons basket-modal__buttons--empty"><a :href="catalog_link">Начать покупки</a></div>
        </div>
    </section>
</template>
