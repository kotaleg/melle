		...
		if ($status) {
			...
			foreach($multideliverys as $i => $delivery) {
				...
				$quote_data['dostavimchekaut1'] = array(
					...
					'title'        => '<label><span id="nameChoice1">'.$deliveryMethodsFrontName0.'<span/><br><span style="color:#999">'.$deliveryMethodsFrontDescription0.'</span></label>',
				...
				$quote_data['dostavimchekaut2'] = array(
					...
					'title'        => '<label><span id="nameChoice2">'.$deliveryMethodsFrontName1.'<span/><br><span style="color:#999">'.$deliveryMethodsFrontDescription1.'</span></label>',
			...
			if($i==3){	
				...
				$quote_data['dostavimchekaut3'] = array(
					...
					'title'        => '<label><span id="nameChoice3">'.$deliveryMethodsFrontName2.'</span> - '.$deliveryMethodsFrontCountDay2.' дн <br><span style="color:#999">'.$deliveryMethodsFrontDescription2.'</span></label>',
			...
			if($i==4){
				...
				$quote_data['dostavimchekaut4'] = array(
					...
					'title'        => '<label><span id="nameChoice4">'.$deliveryMethodsFrontName3.'</span> - '.$deliveryMethodsFrontCountDay3.' дн <br><span style="color:#999">'.$deliveryMethodsFrontDescription3.'</span></label>',
			...
			if($weightDostavim<=5000){
				...
				$quote_data['dostavimchekaut5'] = array(
					...
					'title'        => '<label><span id="nameChoice5">'.$deliveryMethodsFrontName4.'</span> - '.$deliveryMethodsFrontCountDay4.' дн <br><span style="color:#999">'.$deliveryMethodsFrontDescription4.'</span></label>',
